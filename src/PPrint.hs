module PPrint (pp, ppDecl, ppInfer, ppType, ppError, ppConsole, sugar, sugarFuncs) where
...
ppType :: Type -> String
ppType DEFAULT = render . typeColor . pretty $ defaultType
ppType (T t) = render . typeColor . pretty $ t
